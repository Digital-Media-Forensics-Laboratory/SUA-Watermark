...
def parse(args=None):
    ...
    #
    parser.add_argument('--data', type=str, default='CelebA', help="'CelebA' or 'CelebA-HQ'")
    parser.add_argument('--data_path', type=str, default='./data/CelebA/images')
    parser.add_argument('--attr_path', type=str, default='./data/list_attr_celeba.txt')
    parser.add_argument('--image_list_path', type=str, default='./data/image_list.txt')
