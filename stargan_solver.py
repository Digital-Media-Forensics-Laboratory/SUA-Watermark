...
class Solver(object):
    ...
    def test_universal_model_level_attack(self, i, x_real, c_org, pgd_attack, canny_num):
        """Universal Attack by Huang Hao"""
        ...
        for idx, c_trg in enumerate(c_trg_list):
            ...
            # Attacks
            x_adv, perturb = pgd_attack.universal_perturb_stargan(x_real, gen_noattack, c_trg, self.G, canny_num)  # Vanilla
